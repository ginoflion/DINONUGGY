...
namespace DINONUGGY.Sprites
{
    public class Marge : Objetos
    {
        ...
        {
            if (Game1.listaMarge.Any(marge => marge.position == new Vector2(Game1.screenWidth * 2, Game1.screenHeight - 200)))
            {
                return;
            }
            Marge newMarge = new Marge(texture, new Vector2(Game1.screenWidth * 2, Game1.screenHeight - 200), true, damage);
